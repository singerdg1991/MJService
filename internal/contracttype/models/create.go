...
/*
 * @apiDefine: ContractTypesCreateRequestBody
 */
type ContractTypesCreateRequestBody struct {
...
func (data *ContractTypesCreateRequestBody) ValidateBody(r *http.Request) govalidity.ValidityResponseErrors {
