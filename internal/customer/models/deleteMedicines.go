...
/*
 * @apiDefine: CustomersDeleteMedicinesRequestBody
 */
type CustomersDeleteMedicinesRequestBody struct {
...
func (data *CustomersDeleteMedicinesRequestBody) ValidateBody(r *http.Request) govalidity.ValidityResponseErrors {
