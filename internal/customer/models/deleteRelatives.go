...
/*
 * @apiDefine: CustomersDeleteRelativesRequestBody
 */
type CustomersDeleteRelativesRequestBody struct {
...
func (data *CustomersDeleteRelativesRequestBody) ValidateBody(r *http.Request) govalidity.ValidityResponseErrors {
