...
/*
 * @apiDefine: CustomersDeleteServicesRequestBody
 */
type CustomersDeleteServicesRequestBody struct {
...
func (data *CustomersDeleteServicesRequestBody) ValidateBody(r *http.Request) govalidity.ValidityResponseErrors {
