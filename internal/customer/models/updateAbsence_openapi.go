...
/*
 * @apiDefine: CustomersUpdateAbsenceResponseData
 */
type CustomersUpdateAbsenceResponseData struct {
...
/*
 * @apiDefine: CustomersUpdateAbsenceResponse
 */
type CustomersUpdateAbsenceResponse struct {
	StatusCode int                                `json:"statusCode" openapi:"example:200"`
	Data       CustomersUpdateAbsenceResponseData `json:"data" openapi:"$ref:CustomersUpdateAbsenceResponseData"`
}
