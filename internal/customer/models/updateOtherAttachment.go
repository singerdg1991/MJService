...
/*
 * @apiDefine: CustomersUpdateOtherAttachmentRequestParams
 */
type CustomersUpdateOtherAttachmentRequestParams struct {
	ID int `json:"id,string" openapi:"example:1;nullable;pattern:^[0-9]+$;in:path"`
}

func (data *CustomersUpdateOtherAttachmentRequestParams) ValidateParams(params govalidity.Params) govalidity.ValidityResponseErrors {
...
/*
 * @apiDefine: CustomersUpdateOtherAttachmentRequestBody
 */
type CustomersUpdateOtherAttachmentRequestBody struct {
...
func (data *CustomersUpdateOtherAttachmentRequestBody) ValidateBody(r *http.Request) govalidity.ValidityResponseErrors {
	schema := govalidity.Schema{
