...
/*
 * @apiDefine: CustomersUpdateServiceRequestParams
 */
type CustomersUpdateServiceRequestParams struct {
...
func (data *CustomersUpdateServiceRequestParams) ValidateParams(params govalidity.Params) govalidity.ValidityResponseErrors {
