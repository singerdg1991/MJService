...
/*
 * @apiDefine: CyclesShiftCustomerHomeKeyReleaseRequestBody
 */
type CyclesShiftCustomerHomeKeyReleaseRequestBody struct {
...
// ValidateBody validates the request body of CyclesShiftCustomerHomeKeyReleaseRequestBody.
//
...
// Otherwise, it sets the status of the request body to constants.SHIFT_CUSTOMER_HOME_KEY_STATUS_RELEASED
// and returns nil.
//
// Parameters:
...
func (data *CyclesShiftCustomerHomeKeyReleaseRequestBody) ValidateBody(r *http.Request) govalidity.ValidityResponseErrors {
	...
	data.Status = constants.SHIFT_CUSTOMER_HOME_KEY_STATUS_RELEASED
