...
/*
 * @apiDefine: CyclesCreateIncomingShiftAssignToMeRequestBody
 */
type CyclesCreateIncomingShiftAssignToMeRequestBody struct {
...
func (data *CyclesCreateIncomingShiftAssignToMeRequestBody) ValidateBody(r *http.Request) govalidity.ValidityResponseErrors {
