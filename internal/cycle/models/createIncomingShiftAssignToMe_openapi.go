...
/*
 * @apiDefine: CyclesCreateIncomingShiftAssignToMeResponseData
 */
type CyclesCreateIncomingShiftAssignToMeResponseData struct {
...
/*
 * @apiDefine: CyclesCreateIncomingShiftAssignToMeResponse
 */
type CyclesCreateIncomingShiftAssignToMeResponse struct {
	StatusCode int                                             `json:"statusCode" openapi:"example:200"`
	Data       CyclesCreateIncomingShiftAssignToMeResponseData `json:"data" openapi:"$ref:CyclesCreateIncomingShiftAssignToMeResponseData"`
}
