...
/*
 * @apiDefine: CyclesCreateShiftEndRequestBody
 */
type CyclesCreateShiftEndRequestBody struct {
...
// ValidateBody validates the body of the HTTP request for creating a shift end.
//
...
func (data *CyclesCreateShiftEndRequestBody) ValidateBody(r *http.Request) govalidity.ValidityResponseErrors {
