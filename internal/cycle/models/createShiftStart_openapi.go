...
/*
 * @apiDefine: CyclesCreateShiftStartResponseData
 */
type CyclesCreateShiftStartResponseData struct {
...
/*
 * @apiDefine: CyclesCreateShiftStartResponse
 */
type CyclesCreateShiftStartResponse struct {
	StatusCode int                                `json:"statusCode" openapi:"example:200"`
	Data       CyclesCreateShiftStartResponseData `json:"data" openapi:"$ref:CyclesCreateShiftStartResponseData"`
}
