...
/*
 * @apiDefine: CyclesCreateShiftSwapRequestBody
 */
type CyclesCreateShiftSwapRequestBody struct {
...
//
// The function takes an HTTP request as a parameter and checks its body against a schema defined for the CyclesCreateShiftSwapRequestBody struct.
// It returns a govalidity.ValidityResponseErrors object containing any validation errors that occurred.
func (data *CyclesCreateShiftSwapRequestBody) ValidateBody(r *http.Request) govalidity.ValidityResponseErrors {
