...
/*
 * @apiDefine: CyclesCreateVisitAssignResponseData
 */
type CyclesCreateVisitAssignResponseData struct {
...
/*
 * @apiDefine: CyclesCreateVisitAssignResponse
 */
type CyclesCreateVisitAssignResponse struct {
	StatusCode int                                 `json:"statusCode" openapi:"example:200"`
	Data       CyclesCreateVisitAssignResponseData `json:"data" openapi:"$ref:CyclesCreateVisitAssignResponseData"`
}
