...
/*
 * @apiDefine: CyclesCreateVisitCancelRequestBody
 */
type CyclesCreateVisitCancelRequestBody struct {
...
func (data *CyclesCreateVisitCancelRequestBody) ValidateBody(r *http.Request) govalidity.ValidityResponseErrors {
