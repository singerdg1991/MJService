...
/*
 * @apiDefine: CyclesCreateVisitEndRequestBody
 */
type CyclesCreateVisitEndRequestBody struct {
...
func (data *CyclesCreateVisitEndRequestBody) ValidateBody(r *http.Request) govalidity.ValidityResponseErrors {
