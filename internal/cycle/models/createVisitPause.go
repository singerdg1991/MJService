...
/*
 * @apiDefine: CyclesCreateVisitPauseRequestBody
 */
type CyclesCreateVisitPauseRequestBody struct {
...
func (data *CyclesCreateVisitPauseRequestBody) ValidateBody(r *http.Request) govalidity.ValidityResponseErrors {
