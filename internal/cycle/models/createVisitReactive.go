...
/*
 * @apiDefine: CyclesCreateVisitReactiveRequestBody
 */
type CyclesCreateVisitReactiveRequestBody struct {
...
func (data *CyclesCreateVisitReactiveRequestBody) ValidateBody(r *http.Request) govalidity.ValidityResponseErrors {
