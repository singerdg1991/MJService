...
/*
 * @apiDefine: CyclesCreateVisitSosRequestBody
 */
type CyclesCreateVisitSosRequestBody struct {
...
func (data *CyclesCreateVisitSosRequestBody) ValidateBody(r *http.Request) govalidity.ValidityResponseErrors {
