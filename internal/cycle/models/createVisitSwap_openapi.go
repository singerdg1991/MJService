...
/*
 * @apiDefine: CyclesCreateVisitSwapResponseDataItem
 */
type CyclesCreateVisitSwapResponseDataItem struct {
...
/*
 * @apiDefine: CyclesCreateVisitSwapResponseData
 */
type CyclesCreateVisitSwapResponseData struct {
	SourceVisit CyclesCreateVisitSwapResponseDataItem `json:"sourceVisit" openapi:"$ref:CyclesCreateVisitSwapResponseDataItem"`
	TargetVisit CyclesCreateVisitSwapResponseDataItem `json:"targetVisit" openapi:"$ref:CyclesCreateVisitSwapResponseDataItem"`
}

/*
 * @apiDefine: CyclesCreateVisitSwapResponse
 */
type CyclesCreateVisitSwapResponse struct {
	StatusCode int                               `json:"statusCode" openapi:"example:200"`
	Data       CyclesCreateVisitSwapResponseData `json:"data" openapi:"$ref:CyclesCreateVisitSwapResponseData"`
}
