...
/*
 * @apiDefine: CyclesQueryLastResponseDataItemStaffType
 */
type CyclesQueryLastResponseDataItemStaffType struct {
...
/*
 * @apiDefine: CyclesQueryLastResponseDataItemNextStaffType
 */
type CyclesQueryLastResponseDataItemNextStaffType struct {
	ID               uint                      `json:"id" openapi:"example:1"`
...
/*
 * @apiDefine: CyclesQueryLastResponseData
 */
type CyclesQueryLastResponseData struct {
	ID                    uint                                           `json:"id" openapi:"example:1"`
	...
	StaffTypes            []CyclesQueryLastResponseDataItemStaffType     `json:"staffTypes" openapi:"$ref:CyclesQueryLastResponseDataItemStaffType;type:array"`
	NextStaffTypes        []CyclesQueryLastResponseDataItemNextStaffType `json:"nextStaffTypes" openapi:"$ref:CyclesQueryLastResponseDataItemNextStaffType;type:array"`
...
/*
 * @apiDefine: CyclesQueryLastResponse
 */
type CyclesQueryLastResponse struct {
	StatusCode int                         `json:"statusCode" openapi:"example:200;"`
	Data       CyclesQueryLastResponseData `json:"data" openapi:"$ref:CyclesQueryLastResponseData;type:object;"`
}

/*
 * @apiDefine: CyclesQueryLastNotFoundResponse
 */
type CyclesQueryLastNotFoundResponse struct {
