...
/*
 * @apiDefine: CyclesUpdateStaffTypeRequestParams
 */
type CyclesUpdateStaffTypeRequestParams struct {
...
func (data *CyclesUpdateStaffTypeRequestParams) ValidateParams(params govalidity.Params) govalidity.ValidityResponseErrors {
...
/*
 * @apiDefine: CyclesUpdateStaffTypeRequestBody
 */
type CyclesUpdateStaffTypeRequestBody struct {
	...
	ID               int                        `json:"-" openapi:"ignored"`
}

func (data *CyclesUpdateStaffTypeRequestBody) ValidateBody(r *http.Request) govalidity.ValidityResponseErrors {
	schema := govalidity.Schema{
