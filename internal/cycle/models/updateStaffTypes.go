...
/*
 * @apiDefine: CyclesUpdateStaffTypesRequestParams
 */
type CyclesUpdateStaffTypesRequestParams struct {
	CycleID int `json:"cycleid,string" openapi:"example:1;nullable;pattern:^[0-9]+$;in:path"`
}
...
func (data *CyclesUpdateStaffTypesRequestParams) ValidateParams(params govalidity.Params) govalidity.ValidityResponseErrors {
...
/*
 * @apiDefine: CyclesUpdateStaffTypesRequestBodyStaffType
 */
type CyclesUpdateStaffTypesRequestBodyStaffType struct {
...
/*
 * @apiDefine: CyclesUpdateStaffTypesRequestBody
 */
type CyclesUpdateStaffTypesRequestBody struct {
	StaffTypes []*CyclesUpdateStaffTypeRequestBody `json:"staffTypes" openapi:"$ref:CyclesUpdateStaffTypeRequestBody"`
}

func (data *CyclesUpdateStaffTypesRequestBody) ValidateBody(r *http.Request) govalidity.ValidityResponseErrors {
	schema := govalidity.Schema{
