...
/*
 * @apiDefine: LanguageSkillsCreateRequestBody
 */
type LanguageSkillsCreateRequestBody struct {
...
func (data *LanguageSkillsCreateRequestBody) ValidateBody(r *http.Request) govalidity.ValidityResponseErrors {
