...
/*
 * @apiDefine: LicensesCreateRequestBody
 */
type LicensesCreateRequestBody struct {
...
func (data *LicensesCreateRequestBody) ValidateBody(r *http.Request) govalidity.ValidityResponseErrors {
