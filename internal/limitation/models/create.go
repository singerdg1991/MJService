...
/*
 * @apiDefine: LimitationsCreateRequestBody
 */
type LimitationsCreateRequestBody struct {
...
func (data *LimitationsCreateRequestBody) ValidateBody(r *http.Request) govalidity.ValidityResponseErrors {
