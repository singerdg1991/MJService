...
/*
 * @apiDefine: PermissionsDeleteResponseData
 */
type PermissionsDeleteResponseData struct {
...
/*
 * @apiDefine: PermissionsDeleteResponse
 */
type PermissionsDeleteResponse struct {
	StatusCode int                           `json:"statusCode" openapi:"type:integer;example:200"`
	Data       PermissionsDeleteResponseData `json:"data" openapi:"$ref:PermissionsDeleteResponseData;type:object;"`
}
