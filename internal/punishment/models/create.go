...
/*
 * @apiDefine: PunishmentsCreateRequestBody
 */
type PunishmentsCreateRequestBody struct {
...
func (data *PunishmentsCreateRequestBody) ValidateBody(r *http.Request) govalidity.ValidityResponseErrors {
