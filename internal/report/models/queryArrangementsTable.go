...
/*
 * @apiDefine: ReportsQueryArrangementsFilterType
 */
type ReportsQueryArrangementsFilterType struct {
}

/*
 * @apiDefine: ReportsQueryArrangementsSortType
 */
type ReportsQueryArrangementsSortType struct {
}

/*
 * @apiDefine: ReportsQueryArrangementsTableAggregationType
 */
type ReportsQueryArrangementsTableAggregationType struct {
...
/*
 * @apiDefine: ReportsQueryArrangementsTableRequestParams
 */
type ReportsQueryArrangementsTableRequestParams struct {
	...
	Filters                ReportsQueryArrangementsFilterType             `json:"filters,omitempty" openapi:"$ref:ReportsQueryArrangementsFilterType;in:query"`
	Sorts                  ReportsQueryArrangementsSortType               `json:"sorts,omitempty" openapi:"$ref:ReportsQueryArrangementsSortType;in:query"`
	SectionIDsAsInt64Slice []int64                                        `json:"-" openapi:"ignored"`
	AggregationsValue      []ReportsQueryArrangementsTableAggregationType `json:"-" openapi:"ignored"`
	FilterIDsAsInt64Slice  []int64                                        `json:"-" openapi:"ignored"`
}

func (data *ReportsQueryArrangementsTableRequestParams) ValidateQueries(r *http.Request) govalidity.ValidityResponseErrors {
	...
	if data.Aggregations != nil {
		...
		var aggregations []ReportsQueryArrangementsTableAggregationType
		for _, aggregationInterface := range aggregationsInterface {
			...
			aggregation := ReportsQueryArrangementsTableAggregationType{
