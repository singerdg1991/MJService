...
/*
 * @apiDefine: ReportsQueryCustomerLifecycleChartAggregationType
 */
type ReportsQueryCustomerLifecycleChartAggregationType struct {
...
/*
 * @apiDefine: ReportsQueryCustomerLifecycleChartRequestParams
 */
type ReportsQueryCustomerLifecycleChartRequestParams struct {
	...
	AggregationsValue      []ReportsQueryCustomerLifecycleChartAggregationType `json:"-" openapi:"ignored"`
	FilterIDsAsInt64Slice  []int64
}

// ValidateQueries validates the query parameters
func (data *ReportsQueryCustomerLifecycleChartRequestParams) ValidateQueries(r *http.Request) govalidity.ValidityResponseErrors {
	...
	if data.Aggregations != nil {
		...
		var aggregations []ReportsQueryCustomerLifecycleChartAggregationType
		for _, aggregationInterface := range aggregationsInterface {
			...
			aggregation := ReportsQueryCustomerLifecycleChartAggregationType{
