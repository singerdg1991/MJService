...
/*
 * @apiDefine: ReportsQueryCustomerLocationChartAggregationType
 */
type ReportsQueryCustomerLocationChartAggregationType struct {
...
/*
 * @apiDefine: ReportsQueryCustomerLocationChartRequestParams
 */
type ReportsQueryCustomerLocationChartRequestParams struct {
	...
	AggregationsValue      []ReportsQueryCustomerLocationChartAggregationType `json:"-" openapi:"ignored"`
	FilterIDsAsInt64Slice  []int64                                            `json:"-" openapi:"ignored"`
}

// ValidateQueries validates the query parameters
func (data *ReportsQueryCustomerLocationChartRequestParams) ValidateQueries(r *http.Request) govalidity.ValidityResponseErrors {
	...
	if data.Aggregations != nil {
		...
		for _, aggregationInterface := range aggregationsInterface {
			...
			data.AggregationsValue = append(data.AggregationsValue, ReportsQueryCustomerLocationChartAggregationType{
