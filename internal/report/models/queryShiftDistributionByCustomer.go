...
/*
 * @apiDefine: ReportsQueryShiftDistributionByCustomersTableAggregationType
 */
type ReportsQueryShiftDistributionByCustomersTableAggregationType struct {
...
/*
 * @apiDefine: ReportsQueryShiftDistributionByCustomersChartRequestParams
 */
type ReportsQueryShiftDistributionByCustomersChartRequestParams struct {
	...
	AggregationsValue      []ReportsQueryShiftDistributionByCustomersTableAggregationType `json:"-" openapi:"ignored"`
	FilterIDsAsInt64Slice  []int64                                                        `json:"-" openapi:"ignored"`
}

func (data *ReportsQueryShiftDistributionByCustomersChartRequestParams) ValidateQueries(r *http.Request) govalidity.ValidityResponseErrors {
	...
	if data.Aggregations != nil {
		...
		var aggregations []ReportsQueryShiftDistributionByCustomersTableAggregationType
		for _, aggregationInterface := range aggregationsInterface {
			...
			aggregation := ReportsQueryShiftDistributionByCustomersTableAggregationType{
