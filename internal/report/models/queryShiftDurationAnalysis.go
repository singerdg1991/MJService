...
/*
 * @apiDefine: ReportsQueryShiftDurationAnalysisTableAggregationType
 */
type ReportsQueryShiftDurationAnalysisTableAggregationType struct {
...
/*
 * @apiDefine: ReportsQueryShiftDurationAnalysisChartRequestParams
 */
type ReportsQueryShiftDurationAnalysisChartRequestParams struct {
	...
	AggregationsValue      []ReportsQueryShiftDurationAnalysisTableAggregationType `json:"-" openapi:"ignored"`
	FilterIDsAsInt64Slice  []int64                                                 `json:"-" openapi:"ignored"`
}

func (data *ReportsQueryShiftDurationAnalysisChartRequestParams) ValidateQueries(r *http.Request) govalidity.ValidityResponseErrors {
	...
	if data.Aggregations != nil {
		...
		var aggregations []ReportsQueryShiftDurationAnalysisTableAggregationType
		for _, aggregationInterface := range aggregationsInterface {
			...
			aggregation := ReportsQueryShiftDurationAnalysisTableAggregationType{
