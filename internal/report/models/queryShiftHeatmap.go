...
/*
 * @apiDefine: ReportsQueryShiftHeatmapChartAggregationType
 */
type ReportsQueryShiftHeatmapChartAggregationType struct {
...
/*
 * @apiDefine: ReportsQueryShiftHeatmapChartRequestParams
 */
type ReportsQueryShiftHeatmapChartRequestParams struct {
	...
	AggregationsValue      []ReportsQueryShiftHeatmapChartAggregationType `json:"-" openapi:"ignored"`
	FilterIDsAsInt64Slice  []int64                                        `json:"-" openapi:"ignored"`
}

// ValidateQueries validates the query parameters
func (data *ReportsQueryShiftHeatmapChartRequestParams) ValidateQueries(r *http.Request) govalidity.ValidityResponseErrors {
	...
	if data.Aggregations != nil {
		...
		var aggregations []ReportsQueryShiftHeatmapChartAggregationType
		for _, aggregationInterface := range aggregationsInterface {
			...
			aggregation := ReportsQueryShiftHeatmapChartAggregationType{
