...
/*
 * @apiDefine: ReportsQueryShiftsByStaffAndCustomerChartRequestParams
 */
type ReportsQueryShiftsByStaffAndCustomerChartRequestParams struct {
	...
	AggregationsValue      []ReportsQueryShiftsByStaffAndCustomerChartAggregationType `json:"-" openapi:"ignored"`
	FilterIDsAsInt64Slice  []int64                                                    `json:"-" openapi:"ignored"`
}

/*
 * @apiDefine: ReportsQueryShiftsByStaffAndCustomerChartAggregationType
 */
type ReportsQueryShiftsByStaffAndCustomerChartAggregationType struct {
...
func (data *ReportsQueryShiftsByStaffAndCustomerChartRequestParams) ValidateQueries(r *http.Request) govalidity.ValidityResponseErrors {
	...
	if data.Aggregations != nil {
		...
		var aggregations []ReportsQueryShiftsByStaffAndCustomerChartAggregationType
		for _, aggregationInterface := range aggregationsInterface {
			...
			aggregation := ReportsQueryShiftsByStaffAndCustomerChartAggregationType{
