...
/*
 * @apiDefine: StaffsDeleteAbsencesRequestBody
 */
type StaffsDeleteAbsencesRequestBody struct {
...
func (data *StaffsDeleteAbsencesRequestBody) ValidateBody(r *http.Request) govalidity.ValidityResponseErrors {
