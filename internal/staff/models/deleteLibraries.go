...
/*
 * @apiDefine: StaffsDeleteLibrariesRequestBody
 */
type StaffsDeleteLibrariesRequestBody struct {
...
func (data *StaffsDeleteLibrariesRequestBody) ValidateBody(r *http.Request) govalidity.ValidityResponseErrors {
