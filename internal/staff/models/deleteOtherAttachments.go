...
/*
 * @apiDefine: StaffsDeleteOtherAttachmentsRequestBody
 */
type StaffsDeleteOtherAttachmentsRequestBody struct {
...
func (data *StaffsDeleteOtherAttachmentsRequestBody) ValidateBody(r *http.Request) govalidity.ValidityResponseErrors {
