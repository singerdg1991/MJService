...
/*
 * @apiDefine: StaffsCreateLibrariesRequestBody
 */
type StaffsCreateLibrariesRequestBody struct {
...
func (data *StaffsCreateLibrariesRequestBody) ValidateBody(r *http.Request) govalidity.ValidityResponseErrors {
