...
/*
 * @apiDefine: StaffsUpdateAbsenceRequestParams
 */
type StaffsUpdateAbsenceRequestParams struct {
	ID int `json:"id,string" openapi:"example:1;nullable;pattern:^[0-9]+$;in:path"`
}

func (data *StaffsUpdateAbsenceRequestParams) ValidateParams(params govalidity.Params) govalidity.ValidityResponseErrors {
...
/*
 * @apiDefine: StaffsUpdateAbsenceRequestBody
 */
type StaffsUpdateAbsenceRequestBody struct {
...
func (data *StaffsUpdateAbsenceRequestBody) ValidateBody(r *http.Request) govalidity.ValidityResponseErrors {
	schema := govalidity.Schema{
