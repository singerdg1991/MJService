...
/*
 * @apiDefine: StaffsUpdatePersonalInfoRequestParams
 */
type StaffsUpdatePersonalInfoRequestParams struct {
	UserID int `json:"userId,string" openapi:"example:1;nullable;pattern:^[0-9]+$;in:path"`
}

func (data *StaffsUpdatePersonalInfoRequestParams) ValidateParams(params govalidity.Params) govalidity.ValidityResponseErrors {
...
/*
 * @apiDefine: StaffsUpdatePersonalInfoRequestBodyLanguageSkill
 */
type StaffsUpdatePersonalInfoRequestBodyLanguageSkill struct {
	ID   uint   `json:"id" openapi:"example:1"`
	Name string `json:"name" openapi:"example:test;required"`
}

/*
 * @apiDefine: StaffsUpdatePersonalInfoRequestBodyLimitation
 */
type StaffsUpdatePersonalInfoRequestBodyLimitation struct {
	LimitationID uint   `json:"limitationId" openapi:"example:1"`
	Description  string `json:"description" openapi:"example:description"`
}

/*
 * @apiDefine: StaffsUpdatePersonalInfoRequestBody
 */
type StaffsUpdatePersonalInfoRequestBody struct {
	...
	Limitations                      []*StaffsUpdatePersonalInfoRequestBodyLimitation `json:"limitations" openapi:"$ref:StaffsUpdatePersonalInfoRequestBodyLimitation;type:array"`
	VehicleTypesAsStringSlice        []string                                         `json:"-" openapi:"ignored"`
	VehicleLicenseTypesAsStringSlice []string                                         `json:"-" openapi:"ignored"`
}

func (data *StaffsUpdatePersonalInfoRequestBody) ValidateBody(r *http.Request) govalidity.ValidityResponseErrors {
	schema := govalidity.Schema{
