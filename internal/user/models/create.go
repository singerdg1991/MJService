...
/*
 * @apiDefine: UsersCreateRequestBodyLanguageSkill
 */
type UsersCreateRequestBodyLanguageSkill struct {
	ID   uint   `json:"id" openapi:"example:1"`
	Name string `json:"name" openapi:"example:test;required"`
}

/*
 * @apiDefine: UsersCreateRequestBody
 */
type UsersCreateRequestBody struct {
	...
	LanguageSkills       []UsersCreateRequestBodyLanguageSkill `json:"languageSkills" openapi:"$ref:UsersCreateRequestBodyLanguageSkill;type:array;"`
...
func (data *UsersCreateRequestBody) ValidateBody(r *http.Request) govalidity.ValidityResponseErrors {
